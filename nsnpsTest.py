...
files = glob.glob('./test_data/configuration graphs/*')
for f in files:
    os.remove(f)
...
for instance in test_cases:
    ...
    DotExporter(historyNode[0]).to_dotfile(f"./test_data/configuration graphs/SS_instance_{listToStr}.dot")
...
with open(r'./test_data/statistics.txt', 'w') as fp:
